        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            ...
            <div class="bg-white p-6 rounded-xl shadow-lg border-t-4 border-indigo-500">
                ...
                <form method="POST" action="sales.php" class="space-y-4">
                    ...
                    <div>
    <label for="selected_item_display" class="block text-sm font-medium text-gray-700 mb-1">Item to Sell</label>
    <div class="flex space-x-2">
        <input type="text" id="selected_item_display" 
               placeholder="Click Select Item to Choose" readonly
        ...
        <button type="button" onclick="openItemModal()"
            ...
            <div class="bg-white p-6 rounded-xl shadow-lg border-t-4 border-green-500">
                <h2 class="text-xl font-semibold mb-4 text-gray-800">👥 Add New Customer</h2>
                <form method="POST" action="sales.php" class="space-y-4">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Item Sold</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php if (!empty($sales_history)): ?>
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"><?php echo htmlspecialchars($sale['customer_name']); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo htmlspecialchars($sale['item_name']); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo htmlspecialchars($sale['quantity_sold']); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo htmlspecialchars($sale['date_created']); ?></td>
...
<div id="itemModal" class="fixed inset-0 bg-gray-900 bg-opacity-75 hidden items-center justify-center z-50 p-4">
    <div class="bg-white rounded-xl shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-y-auto">
        <div class="p-6 border-b flex justify-between items-center sticky top-0 bg-white z-10">
            ...
            <button onclick="closeItemModal()" class="text-gray-500 hover:text-gray-900 text-xl font-bold">&times;</button>
        </div>
        <div class="p-6">
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    ?>
                        <tr class="hover:bg-indigo-50/50">
                            ...
                            <td class="px-4 py-2 text-sm font-medium text-gray-900"><?php echo htmlspecialchars($item['item_name']); ?></td>
                            <td class="px-4 py-2 text-sm text-gray-700 font-semibold">₱ <?php echo number_format($item['price'], 2); ?></td>
