...
<body class="bg-gray-100">
    ...
    <div id="mainContent" class="ml-64 p-10 <?= $initial_margin_class ?> fade-in-content">
        ...
        <?php if (!empty($message)): ?>
            <div class="p-3 mb-6 rounded-lg bg-green-100 text-green-700 border border-green-300 shadow-sm alert-animation">
                <?php echo $message; ?>
            </div>
        <?php endif; ?>

        <?php if (!empty($err_message)): ?>
            <div class="p-3 mb-6 rounded-lg bg-red-100 text-red-700 border border-red-300 shadow-sm alert-animation">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            ...
            <div class="bg-white p-6 rounded-xl shadow-lg border-t-4 border-indigo-500 transition duration-300 hover:shadow-2xl hover:scale-[1.005]">
                ...
                <form method="POST" action="sales.php" class="space-y-4">
                    ...
                    <div>
                        ...
                        <select id="customer_id" name="customer_id" required
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-indigo-500 bg-white transition duration-150">
                    ...
                    <div>
                        ...
                        <div class="flex space-x-2">
                            <input type="text" id="selected_item_display" placeholder="Click Select Item to Choose"
                                readonly
                                class="flex-grow border border-gray-300 rounded-lg px-3 py-2 bg-gray-50 focus:outline-none cursor-pointer transition duration-150 hover:border-indigo-400">
                            ...
                            <button type="button" onclick="openItemModal()"
                                class="bg-indigo-500 text-white px-4 py-2 rounded-lg hover:bg-indigo-600 transition shadow-sm flex-shrink-0 transform hover:scale-[1.03]">
                                Select Item
                            </button>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" id="qty" name="qty" required min="1" value="1"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-indigo-500 transition duration-150">
                    </div>

                    <button type="submit"
                        class="w-full bg-indigo-600 text-white font-semibold py-2 rounded-lg hover:bg-indigo-700 transition duration-200 shadow-md transform hover:scale-[1.01]">
                        Record Sale
                    </button>
                </form>
            </div>

            <div class="bg-white p-6 rounded-xl shadow-lg border-t-4 border-green-500 transition duration-300 hover:shadow-2xl hover:scale-[1.005]">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <button type="button" onclick="openEditCustomerModal()"
                        class="bg-green-500 text-white font-semibold py-1 px-3 rounded-lg hover:bg-green-600 transition shadow-sm text-sm transform hover:scale-[1.05]">
                ...
                <form method="POST" action="sales.php" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="customer_name" name="customer_name" required
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-green-500 transition duration-150">
                    </div>
                    ...
                    <button type="submit"
                        class="w-full bg-green-600 text-white font-semibold py-2 rounded-lg hover:bg-green-700 transition duration-200 shadow-md transform hover:scale-[1.01]">
                        Add Customer
                    </button>
                </form>
            </div>
    ...
    <div id="itemModal" class="fixed inset-0 bg-gray-900 bg-opacity-75 hidden items-center justify-center z-50 p-4 transition-opacity duration-300">
        <div class="bg-white rounded-xl shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-y-auto modal-content-animation">
                                ...
                                <td class="px-4 py-2 text-center">
                                    <?php if ($item['qty'] > 0): ?>
                                        <button type="button" onclick="selectItem(
                                            ...
                                            class="bg-green-500 text-white px-3 py-1 rounded text-xs hover:bg-green-600 transition transform hover:scale-[1.05]">
                                            Select
                                        </button>
                                    <?php else: ?>
    ...
    <div id="customerEditModal" class="fixed inset-0 bg-gray-900 bg-opacity-75 hidden items-center justify-center z-50 p-4 transition-opacity duration-300">
        <div class="bg-white rounded-xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto modal-content-animation">
            <div class="p-6 border-b flex justify-between items-center sticky top-0 bg-white z-10">
            ...
            <div class="p-6 space-y-4">
                <div>
                    <label for="edit_customer_select" class="block text-sm font-medium text-gray-700 mb-1">Select Customer to Edit</label>
                    <select id="edit_customer_select" onchange="loadCustomerDetails(this.value)"
                        class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 bg-white transition duration-150">
                        <option value="">Select Customer</option>
                        <?php foreach ($customers as $customer): ?>
                            <option value="<?php echo htmlspecialchars($customer['id']); ?>"
                ...
                <form id="customer_edit_form" method="POST" action="sales.php"
                    ...
                    <div>
                        ...
                        <input type="text" id="edit_customer_name" name="customer_name" required
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 transition duration-150">
                    </div>
