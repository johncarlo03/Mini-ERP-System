        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
            ...
            <div class="bg-white p-6 rounded-xl shadow-lg border">
                ...
                <form method="POST" action="supplier.php" class="space-y-4">
                    ...
                    <button type="submit" class="w-full bg-blue-600 text-white font-semibold px-4 py-2 rounded-lg hover:bg-blue-700 transition duration-150">
                        Register Supplier
                    </button>
                </form>
            </div>
            ...
            <div class="bg-white p-6 rounded-xl shadow-lg border">
                ...
                <form method="POST" action="supplier.php" class="space-y-4">
                    ...
                    <button type="submit" class="w-full bg-indigo-600 text-white font-semibold px-4 py-2 rounded-lg hover:bg-indigo-700 transition duration-150">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php foreach ($purchase_orders as $po): ?>
                                <tr class="hover:bg-gray-50 transition duration-100">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"><?php echo htmlspecialchars($po['po_id']); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600"><?php echo htmlspecialchars($po['supplier_name']); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600"><?php echo htmlspecialchars($po['item_name']); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600"><?php echo htmlspecialchars($po['qty']); ?></td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600"><?php echo htmlspecialchars($po['date_created']); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-center">
                                        <?php if ($po['status'] === 'Pending'): ?>
                                            <form method="POST" style="display:inline;">
                                                ...
                                                <button type="submit" class="text-white bg-green-500 hover:bg-green-600 font-semibold py-1 px-3 rounded text-xs transition">
                                                    Receive Stock
                                                </button>
                                            </form>
                                        <?php else: ?>
